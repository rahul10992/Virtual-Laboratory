...
public class RayConverge : MonoBehaviour {
	...
	void Update () {
		if(isHit)
		{
			...
			r1d.LookAt(mr.GetPoint(RayBehaviour.length+5));
			r2d.LookAt(mr.GetPoint(RayBehaviour.length+5));
			r3d.LookAt(mr.GetPoint(RayBehaviour.length+5));
		}
